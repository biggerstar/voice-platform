...
<template>
  ...
  <aside :class="[
  ...
  ]" :style="style" class="can-app-drag fixed left-0 top-0 h-full transition-all duration-150"
    ...
    <div class="flex flex-col justify-between h-full" :style="contentStyle">
      <div class="flex flex-col justify-between no-app-drag">
    ...
    <div v-if="isSidebarMixed" ref="asideRef" :class="{
      'border-l': extraVisible,
    }" :style="extraStyle"
      class="no-app-drag border-border bg-sidebar fixed top-0 h-full overflow-hidden border-r transition-all duration-200">
